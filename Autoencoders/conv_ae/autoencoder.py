...
class Autoencoder:
    """
    Autoencoder represents a Deep Convolutional Autoencoder 
    ...
    def reconstruct(self, images):
        ...
        reconstructed_image = self.decoder.predict(latent_representations)
        return reconstructed_image, latent_representations
    ...
    def _add_bottleneck(self, x):
        """Flatten data and add bottleneck/latent_space (Dense layer)"""
